 ...
 */ 
Select org_session_id, user_name, trade_point, start_date, end_date
...
From org_session t1
 Inner Join trade_cash_box_operation t on t1.org_session_id = t.session_id
 Where :start_date <= t1.end_date
