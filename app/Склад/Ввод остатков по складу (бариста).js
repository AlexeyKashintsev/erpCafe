...
function WhRevisionByBarista(aWhSessionModule) {
    ...
    var whSessionModule = aWhSessionModule ? aWhSessionModule : new P.ServerModule("WhSessionModule");
    ...
    form.btnCloseSession.onActionPerformed = function(evt) {//GEN-FIRST:event_btnCloseSessionActionPerformed
        form.close(true);
