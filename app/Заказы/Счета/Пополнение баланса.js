        ...
        if(anAccountId){
            ...
            yandexForm.innerHTML =   
                    ...
                    <div class="form-group">\n\
                        ...
                        <input type="numeric" name="sum" class="form-control" id="sum" placeholder="Введите сумму" value="'+form.textField.text+'" required>\n\
                    </div>\n\
                     <div class="form-group">\n\
                    ...
                    <div class="form-group">\n\
                        ...
                        <div class="radio" id="bill">\n\
                            <label>\n\
                                <input type="radio" name="radio" value="BL">\n\
                                   Выставить счет (оплата через банк)\n\
                            </label>\n\
                        </div>\n\
                    </div>\n\
            ...
            document.getElementById('bill').onclick = setPaymentBill;
            modal.show();
        }
    };
