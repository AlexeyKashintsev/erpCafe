...
From bill_operations t1
 ...
 Where ((:status = t1.operation_status) or (:status is null and (t1.operation_status is not null and t1.operation_status != 1 and t1.operation_status != 2 and t1.operation_status != 3 and t1.operation_status != 8 and t1.operation_status != 9)))
